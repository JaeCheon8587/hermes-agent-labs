...
def test_default_spawn_wraps_pm_claude_runner_tasks_in_bootstrap(tmp_path, monkeypatch):
    """PM architect/implementer cards with runner commands should autorun before Hermes chat."""
    captured = {}
